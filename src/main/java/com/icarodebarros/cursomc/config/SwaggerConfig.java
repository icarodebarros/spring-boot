...
//				.apis(RequestHandlerSelectors.any()) // Aqui o swagger rastrearia todos os endpoints do projeto
				.apis(RequestHandlerSelectors.basePackage("com.icarodebarros.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot",
				"Esta API é utilizada no curso de Spring Boot e Ionic",
				"Versão 1.0",
